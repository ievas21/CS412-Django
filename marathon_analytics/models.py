...
class Result(models.Model):
    ...
    def get_runners_passed(self):
        '''Return the number of runner eho started before this Result and finished after.'''
    ...
    def get_runner_passed_by(self):
        '''Return the  number of runners who started after this Result and finished before it.'''
...
def load_data():
    ...
    filename = "C:\\Users\\ievas\\OneDrive\\Desktop\\CS412\\2023_chicago_results.csv"
    f = open(filename)
    headers = f.readline()
